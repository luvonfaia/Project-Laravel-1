<x-layout>
    <div class="container py-md-5 container--narrow">
        ...
        <div class="profile-nav nav nav-tabs pt-2 mb-4">
            <a href="#" class="profile-nav-link nav-item nav-link active">Postari:{{$postCount}}</a>
            <a href="#" class="profile-nav-link nav-item nav-link">Urmaritori: 3</a>
            <a href="#" class="profile-nav-link nav-item nav-link">Urmariti: 2</a>
        </div>
